# Portfolio - Coffi Désiré Gnanguy

[![Portfolio](https://img.shields.io/badge/Portfolio-Live-success)](https://mrflex-225.github.io)
[![License](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Language](https://img.shields.io/badge/Language-FR%2FEN-orange)](https://mrflex-225.github.io)
...
├── src/
│   ├── css/
│   │   └── language-switcher.css  # Styles du sélecteur de langue
│   ├── js/
│   │   └── language-switcher.js   # Logique de traduction
│   ├── png/               # Images PNG
│   ├── webp/              # Images WebP optimisées
│   ├── svg/               # Icônes SVG
│   ├── images/            # Screenshots de projets
│   ├── pdf/               # CV en PDF
│   └── mp3/               # Fichiers audio
...
- **Kat Trinity** - Plateforme de livraison (React)
...
- Modifier la classe `light-mode` dans `<body>` (ligne 47 de index.html)
- Ou utiliser le toggle de thème dans l'interface

### Modifier les couleurs
Les couleurs sont définies dans `:root` du fichier `style.css` :
```css
--color-purple: #8000ff;
...
### Ajouter un projet
1. Ajouter l'image dans `src/images/`
...
4. Le site sera disponible sur `https://[username].github.io`

### Autre hébergement
Le portfolio est statique et peut être hébergé sur :
- Netlify
- Vercel
- Firebase Hosting
- Tout serveur web
...
|--------|-------------|------|
| G3K | Laravel | [g3k.fr](https://g3k.fr) |
| Uniteech | Laravel | [uniteech.fr](https://uniteech.fr) |
| Kat Trinity | React | [kat-trinity.com](https://kat-trinity.com) |
...
- Développement d'applications internes avec Angular et Spring Boot
